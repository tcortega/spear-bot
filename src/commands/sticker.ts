...
import { i18n, parseCropPosition } from '../utils';
...
export const command: Command = {
  ...
  async execute(msg: Message, args: string[]): Promise<void> {
    ...
    await bot.client.sendImageAsSticker(msg.from, dataUrl, {keepScale: !crop, removebg, circle, cropPosition, author, pack});
  }
};

function isValidUsage(msg: Message) {
  return msg.type === 'image' || msg.type === 'video' || msg.quotedMsg?.type === 'image' || msg.quotedMsg?.type === 'video';
}
