...
export default class AIPRMWrapper {
  ...
  private readonly endpoint =
    'https://api.aiprm.com/api3/Prompts?Community=&OwnerExternalID=user-dhHa1uzqFLjTIKvOy5KXF133&OwnerExternalSystemNo=1&SortModeNo=2&UserFootprint=';
